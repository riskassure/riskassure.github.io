(function(){
    ...
    function throwDice(){
        ...
        if (gameData.rollSum == 2){
            ...
            // switch player using ternary operator where index before ? is evaluated as true/false
            ...
            gameData.index ? (gameData.index = 0) : (gameData.index = 1);
            game.innerHTML += `<p>Sorry, one of your rolls was a one, 
    ...
    function showCurrentScore(){
        score.innerHTML = `<p>The score for <strong>${gameData.players[0]}</strong> 
            is <strong>${gameData.score[0]}</strong> and the score for 
            <strong>${gameData.players[1]}</strong> is <strong>${gameData.score[1]}</strong></p>`;
    }
})();